...
%\maketitle
\begin{abstract}
Through this manual, we will learn how to blink a Vaman board.
\end{abstract}
\section{Components}
...
\begin{table}[!h]
\centering
\input{./figs/components1.tex}
\caption{}
\label{table:components}
\end{table}
\section{Connecting ESP32 to Vaman}
...
%
\item
Connect the ESP32 pins to Vaman LC as per Table \ref{Table:1}.
\begin{table}[h]
\centering
...
\item
Connect the USB-UART to Vaman LC as per Table \ref{Table:2}.
\begin{table}[h]
\centering
...
\item Execute the following code on ESP32 using USB UART \\
\url {https://github.com/Nagarajunaddi/esp32/blob/main/LCD/Codes/ESP32%20_LCD_Display/src/main.cpp}
\end{enumerate}
