...
\hhline{|-|-}
	...
	{\gnumericPB{\raggedright}\textbf{USB UART}}
...
\hhline{|--|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\raggedright}IC0}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\raggedright}IC0}
\\
\hhline{|--|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\raggedright}TXD}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\raggedright}RXD0}
\\
\hhline{|--|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{RXD}}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{TXD0}}
\\
\hhline{|--|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
